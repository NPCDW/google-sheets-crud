...
pub fn handle() {
    ...
    tokio::spawn(async {
        ...
        tracing::info!("got CTRL-SHUTDOWN. google-sheets-curd is exiting");
        process::exit(0);
    });
    ...
    tokio::spawn(async {
        ...
        tracing::info!("got CTRL-C. google-sheets-curd is exiting");
        process::exit(0);
    });
}
...
pub fn handle() {
    ...
    tokio::spawn(async {
        ...
        sig.recv().await;
        tracing::info!("got SIGTERM signal. google-sheets-curd is exiting");
        process::exit(0);
    });
